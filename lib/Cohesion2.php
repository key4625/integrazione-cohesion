 ...
 * Versione modificata per WordPress Plugin
 * 
 * @version 3.0.1-wp-keysoluzioni 09/07/2025
 * @requires PHP 5.4
 * @author Andrea Vallorani <andrea.vallorani@gmail.com>
 * @modified-by GitHub Copilot AI Assistant & Ing. Michele Cappannari (Key Soluzioni Informatiche)
 ...
 * 
 * MODIFICHE PER WORDPRESS PLUGIN:
 * - Rimosso namespace per compatibilità WordPress
 * - Aggiunto metodo setIdSito() per ID Sito configurabile
 * - Mantenuta compatibilità con versione originale
 * - Ottimizzazioni per ambiente WordPress
 * 
 * CREDITI:
...
class Cohesion2{
    ...
    private $id_sito = 'TEST'; // ID Sito configurabile
    ...
    /**
     * Imposta l'ID Sito per Cohesion (AGGIUNTO)
     * @param string $id_sito ID Sito fornito dalla Regione Marche
     * @return Cohesion2
     */
    public function setIdSito($id_sito){
        if($id_sito) $this->id_sito = $id_sito;
        return $this;
    }
    ...
    /**
     * Metodo check MODIFICATO per supportare ID Sito configurabile
     */
    private function check(){
        ...
        // USA L'ID SITO CONFIGURABILE INVECE DI "TEST" HARDCODED
...
/**
 * Eccezione personalizzata per Cohesion2
 */
